...
public class DoctorsPage {
    ...
    @FindBy(xpath="//*[@id='filters_col_bt']") public WebElement doctorsListText; // Doctors> Doctors Listesi
    ...
    @FindBy(xpath = "//a[text()='Dr. Alejandro Martinez']") public WebElement doctorNameText1; //Doctors>Doktor Alejandro Martinez resmi altında görünen adı
    @FindBy(xpath = "//a[text()='Dr. Emily Chang']") public WebElement doctorNameText2; //Doctors>Doktor Dr. Emily Chang resmi altında görünen adı
